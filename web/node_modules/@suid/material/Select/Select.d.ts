...
declare const Select: {
    <V = any>(props: {
        ...
        onChange?: ((event: import("./SelectInputProps").SelectChangeEvent<any>, child: JSX.Element) => void) | undefined;
