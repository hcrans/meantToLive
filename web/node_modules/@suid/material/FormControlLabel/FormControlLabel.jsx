 ...
 */
const FormControlLabel = $.component(function FormControlLabel({ allProps, otherProps, props, }) {
    ...
    const Label = () => {
        ...
        return (<Show when={isSuidElement(label(), Typography) || props.disableTypography} fallback={<Typography component="span" class={classes.label} {...props.componentsProps.typography}>
            {label()}
          </Typography>}>
        {label()}
      </Show>);
    };
    return (<FormControlLabelContext.Provider value={contextProps}>
      <FormControlLabelRoot {...otherProps} class={clsx(classes.root, otherProps.class)} ownerState={ownerState}>
        {props.control}
        <Label />
